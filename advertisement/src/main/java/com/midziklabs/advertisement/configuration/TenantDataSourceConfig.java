...
import com.midziklabs.advertisement.service.TenantDataSourceService;
import com.midziklabs.advertisement.utils.MultiTenantDataSource;
...
public class TenantDataSourceConfig {
    ...
    public DataSource defaultDataSource(){
        return DataSourceBuilder.create()
            .url("jdbc:mysql://mysql2:3306/midzik_microservice")
            .username("root")
            .password("password")
